...
#    print '\n' + filename
#fn = './data/processed_data/json/luanyi_input/file_15_input_luanyi.json'
#outfn = './data/processed_data/elmo/luanyi_input/file_15_input_luanyi.hdf5'
fn = './data/processed_data/json/luanyi_input/file_18_input_luanyi.json'
outfn = './data/processed_data/elmo/luanyi_input/file_18_input_luanyi.hdf5'
Elmo(fn, outfn)
#print(os.listdir('./data/processed_data/json/luanyi_input/'))
